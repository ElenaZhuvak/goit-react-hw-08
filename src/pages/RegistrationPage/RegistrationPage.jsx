    ...
    <div className='min-h-screen flex flex-col justify-center items-center'>
      <Formik initialValues={initialValues} onSubmit={handleSubmit}>
        ...
        <label className='flex flex-col gap-2'>
          ...
          <button className='px-4 py-2 shadow-2xl rounded-md bg-teal-400 text-white cursor-pointer hover:bg-teal-500' type='submit'>Register</button>
          <p><Link className='text-teal-500' to='/login'>Login</Link> if you already have an account</p>
        </Form>
      </Formik>
    </div>
  );
